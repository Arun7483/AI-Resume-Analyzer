  ...
  template: `
    <section aria-labelledby="jobs-title">
      <div class="flex flex-wrap items-end justify-between gap-4"><div>
        ...
        <p class="mt-2 max-w-2xl text-sm text-slate-500">Individual Adzuna, Jooble, and Jobicy listings ranked against your latest resume.</p>
